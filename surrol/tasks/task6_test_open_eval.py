...
class CustomGauzePick(GauzeRetrieve):
    ...
    def reset(self):
        ...
        # Disable physical collisions between gripper links and gauze
    ...
    def step(self, action):
        ...
        eval_result = eval_success('pick up the gauze and place it on the block', self.obj_id2, self.obj_id, state[0:3])
