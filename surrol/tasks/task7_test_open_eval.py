...
class GauzeRetrieve(PsmEnv):
    ...
    def _env_setup(self):
        ...
        # Disable collisions between PSM and the Spleen
    ...
    def are_all_actions_completed(self):
        return all(waypoint is None for waypoint in self._waypoints)
...
if __name__ == "__main__":
    ...
    print(f"LoRA loaded successfully from: {config.lora_checkpoint}")
