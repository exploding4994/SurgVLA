...
class NeedlePick(PsmEnv):
    ...
    def _env_setup(self):
        ...
        p.configureDebugVisualizer(lightPosition=(0.55, 0.0, 5.3))  # GUI光源
        ...
        p.changeVisualShape(obj_id, -1, specularColor=(0.3, 0.3, 0.3))  # 更柔和的高光
        ...
        # ✅ 正确禁用 PSM (body 1) 和 keydney (obj_id2) 之间的所有碰撞
        psm_id = 1
        keydney_id = obj_id2
        ...
        # 关闭 PSM 每个活动 link 与 keydney base 的碰撞（关键！）
    ...
    def _sample_goal_callback(self):
        ...
        self._waypoints = [None, None]  # four waypoints
