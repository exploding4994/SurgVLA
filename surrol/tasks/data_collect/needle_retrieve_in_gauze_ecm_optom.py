...
if __name__ == "__main__":
    ...
    for idx in range(1, 101):
        ...
        # 创建保存数据的文件夹
        # idx = 2
        os.makedirs('rgb/Benchmark-raw-dataset/task4_2_needle_pick_in_gauze/rgb_images_long_224/' + str(idx),
                    exist_ok=True)
        os.makedirs('rgb/Benchmark-raw-dataset/task4_2_needle_pick_in_gauze/depth_images_long_224/' + str(idx),
                    exist_ok=True)
        os.makedirs('rgb/Benchmark-raw-dataset/task4_2_needle_pick_in_gauze/depth_images_long_224_32float/' + str(idx),
                    exist_ok=True)
        os.makedirs('rgb/Benchmark-raw-dataset/task4_2_needle_pick_in_gauze/mask_images_long_224/' + str(idx),
                    exist_ok=True)
        os.makedirs('rgb/Benchmark-raw-dataset/task4_2_needle_pick_in_gauze/state_data_long_224/' + str(idx),
                    exist_ok=True)
        ...
        while not env.are_all_actions_completed():
            ...
            # 保存各种数据...
            rgb_filename = f'rgb/Benchmark-raw-dataset/task4_2_needle_pick_in_gauze/rgb_images_long_224/' + str(
                idx) + f'/{frame_count:06d}.png'
            cv2.imwrite(rgb_filename, rgb_img)

            depth_filename = f'rgb/Benchmark-raw-dataset/task4_2_needle_pick_in_gauze/depth_images_long_224/' + str(
                idx) + f'/{frame_count:06d}.png'
            cv2.imwrite(depth_filename, depth_img)

            mask_filename = f'rgb/Benchmark-raw-dataset/task4_2_needle_pick_in_gauze/mask_images_long_224/' + str(
                idx) + f'/{frame_count:06d}.png'
            cv2.imwrite(mask_filename, mask_img)

            state_filename = f'rgb/Benchmark-raw-dataset/task4_2_needle_pick_in_gauze/state_data_long_224/' + str(
                idx) + f'/{frame_count:06d}.npy'
            np.save(state_filename, state)
            depth_filename32 = f'rgb/Benchmark-raw-dataset/task4_2_needle_pick_in_gauze/depth_images_long_224_32float/{idx}/{frame_count:06d}.npy'
