...
class VeinCoagulation(PsmEnv):
    ...
    def _env_setup(self):
        ...
        # Disable collisions between the PSM and the vein structure
        ...
        # Red sphere representing the bleeding point
        obj_id = p.loadURDF(
    ...
    def _sample_goal_callback(self):
        ...
        # Waypoint 1: 0.02m above the red sphere, gripper open
        self._waypoints[0] = np.array([pos_obj[0], pos_obj[1],
                                       pos_obj[2] + 0.02 * self.SCALING, yaw, 0.5])

        # Waypoint 2: Lower to the red sphere
        self._waypoints[1] = np.array([pos_obj[0], pos_obj[1],
                                       pos_obj[2] + 0.04, yaw, 0.5])

        # Waypoint 3: Close gripper to clip
