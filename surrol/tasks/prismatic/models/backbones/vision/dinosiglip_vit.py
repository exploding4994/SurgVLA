...
# Registry =>> Supported DinoSigLIP Pairs (as TIMM identifiers)VisionTransformer
...
class DinoSigLIPViTBackbone(VisionBackbone):
    def __init__(
        ...
        self.dino_featurizer: VisionTransformer = timm.create_model(
            ...
            # img_size=self.default_image_size,
            # checkpoint_path='/mnt/disk/sjs/code/VLA-Adapter/pretrained_models/vit_large_patch14_reg4_dinov2/pytorch_model.bin'
        )
        ...
        self.siglip_featurizer: VisionTransformer = timm.create_model(
            ...
            img_size=self.default_image_size
            # img_size=self.default_image_size,
            # checkpoint_path='/mnt/disk/sjs/code/VLA-Adapter/pretrained_models/ViT-SO400M-14-SigLIP/open_clip_pytorch_model.bin'
            # 使用实际文件名
        )
