...
from prismatic.vla.datasets.rlds.oxe.transforms import example_dataset_standardization
# Initialize Overwatch =>> Wraps `logging.Logger`
overwatch = initialize_overwatch(__name__)

# 注册 example_dataset 配置
OXE_DATASET_CONFIGS["example_dataset"] = {
    "image_obs_keys": {
        "primary": "image",
        "wrist": "wrist_image"
    },
    ...
    "standardize_fn": example_dataset_standardization
}
